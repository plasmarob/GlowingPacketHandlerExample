...
// Class that sets up reflection for packet modification
// Don't mess with this unless you know what you're doing
// Used by the PacketInjector
public class PacketReflection {
	...
	public static void sendAllPacket(Object packet) throws Exception {
		for (Player p : Bukkit.getOnlinePlayers()) {
			...
			connection.getClass().getMethod("sendPacket", PacketReflection.getClass("{nms}.Packet")).invoke(connection, packet);
		}
	}
